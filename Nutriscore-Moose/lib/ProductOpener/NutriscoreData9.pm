...
package  ProductOpener::NutriscoreData9;
use Moose;
...
has energy               => ( is => 'rw' , isa => 'Int' , required => 1, default => 0 );
...
has fiber                => ( is => 'rw' , isa => 'Num' , required => 1, default => 0 );
...
has fruits_vegetables_nuts_colza_walnut_olive_oils            => ( is => 'rw' , isa => 'Num', required => 1, default => 0 );
...
has proteins             => ( is => 'rw' , isa => 'Num' , required => 1, default => 0 );
...
has saturated_fat        => ( is => 'rw' , isa => 'Num' , required => 1, default => 0 );
...
has sodium               => ( is => 'rw' , isa => 'Num' , required => 1, default => 0 );
has sodium_points        => ( is => 'rw' , isa => 'Int' , required => 0 );
has sodium_value         => ( is => 'rw' , isa => 'Num' , required => 0 );
has sugars               => ( is => 'rw' , isa => 'Num' , required => 1, default => 0 );
...
has energy_from_saturated_fat            => ( is => 'rw' , isa => 'Num', required => 1, default => 0 );
...
has fruits_vegetables_legumes            => ( is => 'rw' , isa => 'Num', required => 1, default => 0 );
...
has non_nutritive_sweeteners             => ( is => 'rw' , isa => 'Num', required => 1, default => 0 );
...
has salt                                 => ( is => 'rw' , isa => 'Num', required => 1, default => 0 );
...
has negative_points       => ( is => 'rw' , isa => 'Int' , required => 0, default => 0 );
has positive_points       => ( is => 'rw' , isa => 'Int' , required => 0, default => 0 );
has negative_points_max   => ( is => 'rw' , isa => 'Int' , required => 0, default => 0 );
has positive_points_max   => ( is => 'rw' , isa => 'Int' , required => 0, default => 0 );
