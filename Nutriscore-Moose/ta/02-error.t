...
dies_ok { $nutriscore_data_ref->positive_nutrients( [ "foo", ProductOpener::NutriscoreDataa->new() ] ); } "Storing objects in a array for strings";
dies_ok { $nutriscore_data_ref->positive_nutrients_unshift(  ProductOpener::NutriscoreDataa->new() ); } "Unshifting an object into a array for strings";
