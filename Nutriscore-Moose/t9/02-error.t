...
} "error initialising property 'grade'";
...
dies_ok { $nutriscore_data_ref->grade('z')         } "Property 'grade' should be 'a' to 'e'";
...
dies_ok { $nutriscore_data_ref->energy_incr(0.5)   } "Cannot convert an integer property to float when incrementing";
$nutriscore_data_ref->is_cheese(1);
dies_ok { $nutriscore_data_ref->is_cheese_incr()   } "Cannot convert an boolean property to integer when incrementing";

dies_ok { $nutriscore_data_ref->positive_nutrients( [ "foo", ProductOpener::NutriscoreData9->new() ] ); } "Storing objects in a array for strings";
dies_ok { $nutriscore_data_ref->positive_nutrients_unshift(  ProductOpener::NutriscoreData9->new() ); } "Unshifting an object into a array for strings";
