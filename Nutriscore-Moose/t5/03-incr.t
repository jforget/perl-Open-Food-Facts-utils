...
my $nutriscore_data_ref = ProductOpener::NutriscoreData5->new(
  # Nutrients
  energy              =>  518,     # in kJ
  sugars              => 3,
  saturated_fat       => 0.7,
...
$nutriscore_data_ref->sugars(   $nutriscore_data_ref->sugars   + 1);
$nutriscore_data_ref->proteins( $nutriscore_data_ref->proteins + 1);
...
for my $data (@test_data) {
  ...
  $nutriscore_data_ref->$nutrient($nutriscore_data_ref->$nutrient + $delta);
}
