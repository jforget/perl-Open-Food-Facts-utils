...
for my $nutriscore_data_ref_old (@test_2021) {
  ...
  for my $nutrient (@nutrient_2021) {
    if (defined $nutriscore_data_ref_old->{$nutrient}) {
      ...
      my $test = ProductOpener::Nutriscore8::get_value_with_one_less_negative_point_2021 ($nutriscore_data_ref_new, $nutrient);
      ...
      $test = ProductOpener::Nutriscore8::get_value_with_one_more_positive_point_2021 ($nutriscore_data_ref_new, $nutrient);
...
for my $nutriscore_data_ref_old (@test_2023) {
  ...
  for my $nutrient (@nutrient_2023) {
    if (defined $nutriscore_data_ref_old->{$nutrient}) {
      ...
      my $test = ProductOpener::Nutriscore8::get_value_with_one_less_negative_point_2023 ($nutriscore_data_ref_new, $nutrient, $nutriscore_data_ref_new->$nutrient);
      ...
      $test = ProductOpener::Nutriscore8::get_value_with_one_more_positive_point_2023 ($nutriscore_data_ref_new, $nutrient, $nutriscore_data_ref_new->$nutrient);
