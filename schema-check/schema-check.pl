...
my $dir_sch = '/home/jf/Documents/prog/perl/perl-Open-Food-Facts-utils/schema-check/schemas';
...
my $dir_ex = '/home/jf/Documents/prog/perl/perl-Open-Food-Facts-utils/schema-check/examples';
my @data_files = map { catfile($dir_ex, $_) }  qw/off1 off2 off3 off4 short/;
if (@ARGV) {
  @data_files = @ARGV;
}
