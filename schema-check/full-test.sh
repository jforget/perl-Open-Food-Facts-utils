...
perl schema-check.pl $def_sch examples/off* examples/test-errors -l      > $dir_res/$base-listing
perl schema-check.pl $def_sch examples/off* examples/test-errors -l -m 1 > $dir_res/$base-dyn
perl schema-check.pl $def_sch examples/example.txt examples/ingredients examples/nova-groups > $dir_res/$base-other
perl schema-check.pl $def_sch examples/products-324.json > $dir_res/$base-324
perl schema-check.pl $def_sch examples/multi*            > $dir_res/$base-multi
